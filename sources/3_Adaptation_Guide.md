...
- Recognizes when AI is operating outside its domain
...
> "Demonstrates sophisticated judgment about different AI agents. Clearly explains which sources are reliable for different topics and why. Strategically sequences conversations and asks targeted follow-ups. Cross-validates findings. Recognizes when AI is speculating vs. reporting factual information."
...
- Recognizes limitations of training data or AI knowledge cutoff
...
- Recognizes when AI solution is inefficient or incorrect
...
- Recognizes aesthetic/conceptual limitations of AI output
...
**Example (Excellent):**
> "Demonstrates awareness of ethical implications of AI use. Clear about professional accountability. Recognizes when AI judgment conflicts with professional standards."
...
- [ ] Customize performance level descriptors with your specific assignment details
...
✓ **Do:** Customize weights and descriptors to your field

❌ **Don't:** Focus only on tool efficiency (faster ≠ better)
✓ **Do:** Reward critical thinking about AI, not speed of output

❌ **Don't:** Punish AI use; incentivize it being hidden
✓ **Do:** Make transparency and critical evaluation rewarded behaviors
